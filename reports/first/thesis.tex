...
\subsection{Существующие алгоритмы построения дескрипторов}{
	...
	TODO: краткое описание SIFT, SURF без уклона в детектор, только дескрипторы.
	Сравнение, почему DAISY эффективнее.
}
...
\section{Разработка алгоритма построения дескрипторов изображений}
{
	\subsection{Алгоритм построения дескрипторов}
	{
		...
		\begin{figure}[H]
			\centering                             
			\includegraphics[width=0.49\textwidth,keepaspectratio]{daisy/bike_source.png}   
			\includegraphics[width=0.49\textwidth,keepaspectratio]{daisy/bike_gradient.png}       
		...
		\begin{figure}[H]
			\centering                             
			\includegraphics[width=0.49\textwidth,keepaspectratio]{daisy/bike_gradient_COM_1.png}   
			\includegraphics[width=0.49\textwidth,keepaspectratio]{daisy/bike_gradient_COM_2.png}       
...
%	\item{Deng, G. An adaptive Gaussian filter for noise reduction and edge detection [Текст] / G. Deng, L. W. Cahill // IEEE Conference Record. -- IEEE Computer Society Washington, DC, USA, 1993. -- P. 1615-1619.}{\label{gaussian filter}}
 	\item{OpenCV Documentation [Электронный ресурс] : официальная документация библиотеки OpenCV. / Intel Corporation, Willow Garage Inc., Itseez Ltd. -- Электрон. дан. -- 2019. -- URL: \\https://docs.opencv.org (дата обращения: 25.04.2019). }{\label{cv docs}}
\end{enumerate}
